...
2. **Main Dashboard**  
   <img src="https://github.com/user-attachments/assets/374446ec-8605-4878-8164-393489aa343e" alt="Main Dashboard" width="500" height="300">
   ...
   - **Monitoring**  
     ...
     <img src="https://github.com/user-attachments/assets/ece4b6f8-c9bc-4d4c-bb7d-180b80bc7519" alt="Monitoring" width="500" height="300">

   - **View Alerts**  
     View all alerts generated during the monitoring process.  
     <img src="https://github.com/user-attachments/assets/6be2a6ad-1915-452a-b792-9107b267f046" alt="View Alerts" width="500" height="300">

   - **Report Problem**  
     Submit a problem or false positive issue.  
     - Add a picture and detailed text description of the issue.  
     <img src="https://github.com/user-attachments/assets/a01e07a5-aef0-4698-a33d-b430e1c69927" alt="Report Problem" width="500" height="300">
   ...
   - **Receive Notifications**  
     ...
     <img src="https://github.com/user-attachments/assets/4b453650-f829-485b-a754-745c5d954cb0" alt="Notifications" width="500" height="300">
...
### Admin Side
**Main Dashboard**  
<img src="https://github.com/user-attachments/assets/40732f96-691f-4806-bf13-0fcbbe32bd0d" alt="Admin Dashboard" width="500" height="300">

1. **Management Accounts**  
   - View pending signup requests.
   - Approve or reject user accounts.  
   <img src="https://github.com/user-attachments/assets/b73ed25d-d58d-4e13-8952-694b1a492924" alt="Manage Accounts" width="500" height="300">

2. **Handle Complaints**  
   - View complaints with attached pictures and descriptions.
   - Take actions to resolve the reported issues.  
   <img src="https://github.com/user-attachments/assets/df020fd7-bc63-4006-aed3-ca13ab324c19" alt="Handle Complaints" width="500" height="300">
